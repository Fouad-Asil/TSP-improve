#!/bin/bash
# Script to run comparison with TensorBoard logging disabled
...
echo "=== Running comparison experiment with TensorBoard logging disabled ==="
...
LOG_FILE="$LOG_DIR/comparison_nolog_$TIMESTAMP.log"
...
# Run comparison part only, with TensorBoard logging disabled
